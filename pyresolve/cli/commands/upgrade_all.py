...
def upgrade_all(
    ...
    Examples:
        ...
        pyresolve upgrade-all --tier1-only
        pyresolve upgrade-all --include pydantic --include fastapi
        pyresolve upgrade-all --exclude pandas
        pyresolve upgrade-all --no-update-deps
        pyresolve upgrade-all --dry-run
    """
